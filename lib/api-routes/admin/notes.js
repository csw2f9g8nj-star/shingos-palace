...
async function handler(req, res) {
  ...
  try {
    ...
    if (payload.note_text.length > 5000 || payload.category.length > 80) {
      sendJson(res, 400, { ok: false, error: "Keep notes under 5,000 characters and categories under 80 characters." });
      return;
    }
